...
from propagator.gravity import (
    load_gravity_coefficients,
    spherical_harmonic_gravity,
    ecef_gravity_to_eci,
)
from coordinates.frames import eci_to_ecef
...
def high_order_gravity_eci(
    ...
    from coordinates.frames import ecef_to_eci
...
def srp_acceleration_eci(
    ...
    """ECI 太阳光压加速度 (薄封装)。"""
    from propagator.srp import srp_acceleration
...
def third_body_acceleration_eci(
    ...
    """ECI 日月三体引力总加速度 (薄封装)。"""
    from propagator.third_body import third_body_sun_moon
...
def compute_total_acceleration_upgraded(
    ...
    if max_deg <= 2:
        ...
        from propagator.gravity_fast import (
